...
| 类型 | 地址 |
|---|---|
| GitHub 仓库 | https://github.com/yc20041001/resume-analyzer |
| 前端演示 | https://yc20041001.github.io/resume-analyzer/ |

> 说明：GitHub Pages 部署的是前端静态页面。若要在线完整体验“上传 PDF + AI 解析 + 匹配评分”，需要将后端部署到阿里云函数计算 FC 或其他公网服务，并将前端 API 地址配置为后端公网地址。
